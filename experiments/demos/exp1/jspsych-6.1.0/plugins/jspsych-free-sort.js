...
jsPsych.plugins['free-sort'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<div style="display: flex; vertical-align: middle;"><div class="tick">Fast  </div><div '+
      'id="jspsych-free-sort-arena" '+
      'class="jspsych-free-sort-arena" '+
      'style="position: relative; width:'+trial.sort_area_width+'px; height:'+trial.sort_area_height+'px; border:2px solid #444; margin-left: auto; margin-right: auto;"'+
      '></div><div class="tick">  Slow</div></div></br>';
    ...
    var init_locations = [];
    var shuffled_locations = shuffle([{x:140,y:0},{x:280,y:0},{x:420,y:0},{x:560,y:0}]);
