...
jsPsych.plugins['survey-likert'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += ".jspsych-survey-likert-statement { display:block; font-size: 20px; padding-top: 25px; margin-bottom:10px; }"+
      ".jspsych-survey-likert-opts { list-style:none; width:"+w+"; margin:auto; padding:0 0 40px; display:block; font-size: 15px; line-height:1.5em; }"+
      ".jspsych-survey-likert-opt-label { line-height: 1.1em; color: #FFFFFF; }"+

      ".jspsych-survey-likert-opts:before { content: ''; position:static; top:11px; /*left:9.5%;*/ display:block; background-color:#efefef; height:4px; width:100%; }"+
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      // add question
      html += '<label class="jspsych-survey-likert-statement" style="color:white;">' + question.prompt + '</label>';
      // add options
