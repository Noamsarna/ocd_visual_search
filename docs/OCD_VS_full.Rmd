...
round(mean(exp2.acc_df$Zscore), 2)
round(sd(exp2.acc_df$Zscore), 2)
...
## Procedure
  A static version of Experiment 2 can be accessed here: https://noamsarna.github.io/ocd_visual_search/experiments/demos/exp2/
