...
As anticipated, a one-tailed paired t-test demonstrated a steeper slope for the difficult search `r apa_print(` (104.76 ms/item) compared to the easy search (39.19 ms/item), `r apa_print(t.test(estimate~search_type, data=search_slopes_df, paired=T))`
