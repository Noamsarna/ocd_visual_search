...
df<- read_csv('../data/Exp1_anon_jatos_results_p1.csv')
df2<- read_csv('../data/Exp1_anon_jatos_results_p2.csv')

df <- rbind(df, df2)
rm(df2)

#load anon prolific data 
demo_prolific <- read.csv('../data/Exp1_anon_demo_prolific.csv')
...
# Pre processing  ---------------------------------------------------------
#load df from jatos 
exp2.jatos_df <-read_csv("../data/Exp2_anon_jatos_results.csv")
...
**Figure 2** *Results from Experiment 1, Experiment 2 and Toffolo et al., 2013, 2014*

```{r figure_2}
knitr::include_graphics("figures/figure_2.png")
```

*note* Mean reaction times for target-absent and target-present trials (X-axis). Error bars represent the standard error of the mean. Shapes represent the OC groups: Circle for OC+; Triangle for OC-.
