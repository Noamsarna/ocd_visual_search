...
# I also need to include only the high and low OC participants. 
...
NS: This analysis is almost exactly like hypothesis 6 except that here we look on the entire sample (so we need to add the two mid quartiles groups.)
