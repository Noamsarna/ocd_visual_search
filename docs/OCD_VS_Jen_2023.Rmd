...
Consistent with our hypotesis, we found a significance difference between the slope of the easy search (C in O) and the slope of the hard search (C in O) in the first trials of each block type. This significant difference between the search slopes indicate that subjects had some sort of metacognitive knowledge allowing them to terminate the easy search faster than the hard search.  
